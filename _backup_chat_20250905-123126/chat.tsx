...
export default function ChatGuardado5() {
  ...
  // Auto-scroll cuando crece (si hay overflow)
  useEffect(() => {
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      // PREVIEW: solo si hay intención (sector) y NO en offtopic
  ...
  // Pocas burbujas = sin scroll; si crece, activa scroll
