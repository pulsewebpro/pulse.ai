...
export default function ChatV2(){
  ...
  const processIdea = async (raw: string) => {
    ...
    try{
      ...
      const pitch =
        `Raquel, asumo estilo **premium cálido** (lo cambio si quieres).\n\n` +
  ...
  return (
    <div className="pulsev2-page">
      ...
      {/* ====== STYLED-JSX (encapsulado, no afecta global) ====== */}
      <style jsx>{`
        .pulsev2-page{ min-height:100vh; padding:24px; }
        .pulsev2-wrap{ max-width:1200px; margin:0 auto; }
        .pulsev2-grid{
          display:grid; grid-template-columns: 380px 1fr; gap:24px; align-items:flex-start;
        }
        ...
        .pulsev2-chip{
          padding:6px 10px; border-radius:9999px; border:1px solid rgba(56,189,248,.25);
          background:rgba(8,30,50,.35); color:#CFE8FF; cursor:pointer; font-weight:600;
        }
        .pulsev2-chip:hover{ transform:translateY(-1px); }

        .pulsev2-chat{
          min-height:420px; max-height:540px; overflow:auto; padding:12px;
        ...
        .pulsev2-card{
          padding:12px; border:1px solid rgba(56,189,248,.2); border-radius:16px; background:rgba(2,8,15,.35);
        }
        .pulsev2-cta{
          display:inline-block; padding:10px 14px; border-radius:9999px; border:1px solid rgba(255,215,0,.7);
        ...
        .pulsev2-text{
          flex:1; padding:12px 14px; border-radius:14px; background:rgba(8,30,50,.35);
          border:1px solid rgba(56,189,248,.25); color:#E6F3FF;
        }
        .pulsev2-send{
          padding:12px 16px; border-radius:14px; background:linear-gradient(180deg,#FF9F45,#FFD700);
        ...
        @media (max-width: 980px){
          .pulsev2-grid{ grid-template-columns: 1fr; }
          .pulsev2-left{ position:static; }
          .pulsev2-left img{ max-width:280px; margin:0 auto; }
          .pulsev2-chat{ max-height:60vh; }
        }
      `}</style>
    </div>
  );
